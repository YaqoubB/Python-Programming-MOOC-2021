...
class RockPaperScissors(WordGame):
    ...
    def round_winner(self, player1_word: str, player2_word: str):
        if player1_word not in "rockpaperscissors" and player2_word not in "rockpaperscissors":
            pass
        elif player1_word not in "rockpaperscissors":
            return 2
        elif player2_word not in "rockpaperscissors":
            return 1
